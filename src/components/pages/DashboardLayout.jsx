    ...
    <div className="flex h-screen bg-gray-50 overflow-hidden overflow-x-hidden">
      ...
      >
        ...
        <div className="flex-shrink-0 p-4">
          <button className="flex items-center gap-3 w-full text-[13px]  font-medium text-gray-700  rounded-md mb-10">
            <img
              src={SettingImage}
              alt="Trello"
              className="w-[17px] h-[17px ml-[2px] text-gray-500"
            />
            <span className="mb-[2px]">{!collapsed && "Settings"}</span>
          </button>
